...
function custom_post_type()
{
	...
	$taxo_labels = array(
		...
		'search_items' => __('Search Category', 'twentytwentyone'),
		'popular_items' => __('Popular Category', 'twentytwentyone'),
		'all_items' => __('All Category', 'twentytwentyone'),
		'parent_item' => null,
		'parent_item_colon' => null,
		'edit_item' => __('Edit category', 'twentytwentyone'),
		'update_item' => __('Update category', 'twentytwentyone'),
		'add_new_item' => __('Add New category', 'twentytwentyone'),
		'new_item_name' => __('New category Name', 'twentytwentyone'),
		'separate_items_with_commas' => __('Separate Category with commas', 'twentytwentyone'),
		'add_or_remove_items' => __('Add or remove Category', 'twentytwentyone'),
		'choose_from_most_used' => __('Choose from the most used Category', 'twentytwentyone'),
		'not_found' => __('No Category found.', 'twentytwentyone'),
		'menu_name' => __('Category', 'twentytwentyone'),
	);
	...
	register_taxonomy('category', 'Blog', $taxo_args);
}
