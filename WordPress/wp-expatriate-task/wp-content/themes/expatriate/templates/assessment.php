    ...
    <section class="common-section">
        <div class="container">
            <form class="assessment-form">
                <p>For us to give you a preliminary assessment of your suitability for Canadian PR please share the
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3 col-md-3 col-lg-2">
                                    <ul class="radio-list">
                                        <li>
                                            <input type="radio" name="rtest" checked="checked" id="rad1"
                ...
                <div>
                    <div class="form-group">
                        ...
                        <label>It must have been continuous, paid, full-time (or an equal amount in part-time), and
                            in only one occupation</label>
