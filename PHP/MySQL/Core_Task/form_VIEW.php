        ...
        <tr>
            ...
            <td>
                ...
                <form action="form_DELETE.php" method="post">
                    ...
                    <!-- EDIT Button -->
                    <button name = "e_user" class="btn btn-info" > <a href="form_EDIT.php?u_id=<?=$row['id']?>" style='text-decoration:none;'> EDIT USER </a></button>

                    <!-- VIEW POST Button -->
                    <button name = "vpostbtn" class="btn btn-info" > <a href="post_VIEW.php?u_id=<?=$row['id']?>" style='text-decoration:none;'> VIEW POSTS </a></button>
                </td>
                </form>
            </tr>
    <?php
